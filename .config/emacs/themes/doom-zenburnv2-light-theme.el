;;; doom-zenburnv2-theme.el --- port of the popular Zenburn theme -*- lexical-binding: t; no-byte-compile: t; -*-
;;
;;; Commentary:
;;; Code:
...
(def-doom-theme doom-zenburnv2-light
                ...
                (
                 ...
                 (variables      fg)
                 (numbers        fg)
                 (region         (doom-lighten base1 0.15))
                 (error          red)
                 (warning        yellow)
                 (success        green)
                 (vc-modified    orange)
  ...
  ;;;; Base theme face overrides
                ((cursor :foreground fg :background blue)
                 ...
                 (font-lock-doc-face :foreground grey)
   ...
   ;;;; ivy
                 ...
                 (ivy-minibuffer-match-face-2 :foreground green+2 :weight 'bold)
   ;;;; js2-mode
   ...
   ;;;; woman <built-in>
    ...
    (diredp-date-time              :foreground blue)
                 ...
                 (tree-sitter-hl-face:keyword :foreground yellow :weight 'regular)
...
;;; doom-zenburnv2-theme.el ends here
