...
;; ============================================================================
;; Zenburn Light - Custom Palette
;; ============================================================================
;; Colors from doom-zenburnv2-light-theme.el

(defvar zenburn-light-theme-colors
  '(:base00 "#d7d5c3"    ;; bg
    :base01 "#d1d0c7"    ;; bg-alt
    :base02 "#bcbcb5"    ;; base1
    :base03 "#7a7d7a"    ;; grey (comments)
    :base04 "#5F5F5F"    ;; base6
    :base05 "#4b4b48"    ;; fg
    :base06 "#4b4b48"    ;; fg-alt
    :base07 "#000000"    ;; base0 (darkest)
    :base08 "#7d4242"    ;; red
    :base09 "#784367"    ;; orange/magenta
    :base0A "#855959"    ;; yellow
    :base0B "#4a6934"    ;; green
    :base0C "#266662"    ;; teal
    :base0D "#3c6362"    ;; blue
    :base0E "#784367"    ;; magenta
    :base0F "#784367")   ;; cyan
  "Custom zenburn light colors from doom-zenburnv2-light.")

(deftheme zenburn-light)
(base16-theme-define 'zenburn-light zenburn-light-theme-colors)
(provide-theme 'zenburn-light)

(provide 'zenburn-light-theme)

;;; zenburn-light-theme.el ends here
