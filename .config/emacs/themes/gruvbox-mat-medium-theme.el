...
;;;; org-mode
     ...
     (org-level-1                                  :foreground base0A)     ;; yellow - bright but warm
     (org-level-2                                  :foreground base0C)                 ;; teal - calm
     (org-level-3                                  :foreground base09)                 ;; green - natural
     (org-level-4                                  :foreground base0B)                 ;; orange - warm accent
     (org-level-5                                  :foreground base0D)                 ;; blue - cool accent
     (org-level-6                                  :foreground base08)                 ;; magenta
     (org-level-7                                  :foreground base0E)                 ;; red
     (org-level-8                                  :foreground base06)                 ;; fg-alt     (org-link                                     :foreground base0E)
...
;; ============================================================================
;; Gruvbox Material Medium - Custom Palette
;; ============================================================================
;; Colors from doom-gruvbox-material-theme.el (medium variant)

(defvar gruvbox-mat-medium-theme-colors
  '(:base00 "#292828"    ;; bg
    :base11 "#242424"    ;; bg
    :base12 "#202020"    ;; bg
    :base01 "#32302f"    ;; bg2
  ...
  "Custom gruvbox material medium colors from doom-gruvbox-material.")

(deftheme gruvbox-mat-medium)
(base16-theme-define 'gruvbox-mat-medium gruvbox-mat-medium-theme-colors)
(provide-theme 'gruvbox-mat-medium)

(provide 'gruvbox-mat-medium-theme)

;;; gruvbox-mat-medium-theme.el ends here
