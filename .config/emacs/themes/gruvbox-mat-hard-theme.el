...
;;;; dashboard
     (dashboard-banner-logo-title                  :foreground base05 :weight bold)
     (dashboard-heading                            :foreground base0D :weight bold :underline nil)
     (dashboard-items-face                         :foreground base05 :underline nil)
     (dashboard-no-items-face                      :foreground base03)
     (dashboard-navigator                          :foreground base0C)

;;;; font-lock
     (font-lock-builtin-face                       :foreground base0E)  ;; magenta
     (font-lock-comment-delimiter-face             :foreground base03)
     (font-lock-comment-face                       :foreground base03)
     (font-lock-constant-face                      :foreground base0E)  ;; magenta (constants)
     (font-lock-doc-face                           :foreground base04)
     (font-lock-doc-string-face                    :foreground base03)
     (font-lock-function-name-face                 :foreground base0B)  ;; green (functions)
     (font-lock-keyword-face                       :foreground base08)  ;; red (keywords/operators)
     (font-lock-negation-char-face                 :foreground base08)  ;; red (operators)
     (font-lock-preprocessor-face                  :foreground base0E)  ;; magenta
     (font-lock-regexp-grouping-backslash          :foreground base0A)
     (font-lock-regexp-grouping-construct          :foreground base0E)
     (font-lock-string-face                        :foreground base0A)  ;; yellow (strings)
     (font-lock-type-face                          :foreground base0D)  ;; blue (types)
     (font-lock-variable-name-face                 :foreground base05)  ;; fg (variables)
     (font-lock-warning-face                       :foreground base08)
     (font-lock-number-face                        :foreground base0E)  ;; magenta (numbers)
     (font-lock-operator-face                      :foreground base08)  ;; red (operators)
     (font-lock-punctuation-face                   :foreground base04)  ;; grey1 (punctuation)
     (font-lock-bracket-face                       :foreground base04)  ;; grey1 (brackets)
     (font-lock-delimiter-face                     :foreground base04)  ;; grey1 (delimiters)
...
;;;; org-mode
     ...
     (org-agenda-date                              :foreground base0D)
     (org-agenda-date-today                        :foreground base09)
     (org-agenda-date-weekend                      :foreground base0E)
     (org-agenda-done                              :foreground base0B)
     (org-agenda-dimmed-todo-face                  :foreground base04)
     (org-block                                    :foreground base05 :background base01 :extend t)
     (org-block-begin-line                         :foreground base04 :background base01 :extend t)
     (org-block-end-line                           :foreground base04 :background base01 :extend t)
     (org-code                                     :foreground base0C :background base01)
     (org-column                                   :background base01)
     (org-column-title                             :underline t :inherit org-column)
     (org-date                                     :foreground base0C)
     (org-document-info                            :foreground base0C)
     (org-document-info-keyword                    :foreground base04)
     (org-document-title                           :foreground base0D)
     (org-done                                     :foreground base09)
     (org-drawer                                   :foreground base04)
     (org-ellipsis                                 :foreground base04)
     (org-footnote                                 :foreground base0C :background base01)
     (org-formula                                  :foreground base09 :background base01)
     (org-headline-done                            :foreground base04)
     (org-hide                                     :foreground base00)
     (org-level-1                                  :foreground base0A)
     (org-level-2                                  :foreground base0D)
     (org-level-3                                  :foreground base0B)
     (org-level-4                                  :foreground base09)
     (org-level-5                                  :foreground base08)
     (org-level-6                                  :foreground base08)
     (org-level-7                                  :foreground base08)
     (org-level-8                                  :foreground base05)
     (org-link                                     :foreground base0E)
     (org-priority                                 :foreground base09)
     (org-property-value                           :foreground base05)
     (org-scheduled                                :foreground base0B)
     (org-scheduled-previously                     :foreground base09)
     (org-scheduled-today                          :foreground base0B)
     (org-special-keyword                          :foreground base04)
     (org-table                                    :foreground base0A :background base01)
     (org-tag                                      :foreground base04)
     (org-todo                                     :foreground base08)
     (org-upcoming-deadline                        :foreground base09)
     (org-verbatim                                 :foreground base0A)
     (org-warning                                  :foreground base08)
     (org-checkbox                                 :foreground base0D)
     (org-checkbox-statistics-done                 :foreground base0B)
     (org-checkbox-statistics-todo                 :foreground base08)
...
;;;; which-key
     (which-key-key-face                           :foreground base0A)                     ;; yellow keys
     (which-key-command-description-face           :foreground base08)                     ;; red commands
     (which-key-group-description-face             :foreground base0D)                     ;; blue groups
     (which-key-separator-face                     :foreground base03)                     ;; grey separator
     (which-key-local-map-description-face         :foreground base0C)                     ;; teal local maps
     (which-key-special-key-face                   :foreground base09)                     ;; orange special keys
     (which-key-note-face                          :foreground base04)                     ;; grey notes

;;;; tree-sitter / treesit
     (tree-sitter-hl-face:type                     :foreground base0D :weight normal)
     (tree-sitter-hl-face:type.builtin             :foreground base0D :weight normal)
     (tree-sitter-hl-face:type.parameter           :foreground base0D :weight normal)
     (tree-sitter-hl-face:type.argument            :foreground base0D :weight normal)
     (tree-sitter-hl-face:function                 :foreground base0B :weight normal)
     (tree-sitter-hl-face:function.call            :foreground base0B :weight normal)
     (tree-sitter-hl-face:function.builtin         :foreground base0B :weight normal)
     (tree-sitter-hl-face:function.method          :foreground base0B :weight normal)
     (tree-sitter-hl-face:function.method.call     :foreground base0B :weight normal)
     (tree-sitter-hl-face:method                   :foreground base0B :weight normal)
     (tree-sitter-hl-face:method.call              :foreground base0B :weight normal)
     (tree-sitter-hl-face:property                 :foreground base05 :weight normal)
     (tree-sitter-hl-face:property.definition      :foreground base05 :weight normal)
     (tree-sitter-hl-face:variable                 :foreground base05 :weight normal)
     (tree-sitter-hl-face:variable.builtin         :foreground base05 :weight normal)
     (tree-sitter-hl-face:variable.parameter       :foreground base05 :weight normal)
     (tree-sitter-hl-face:variable.special         :foreground base05 :weight normal)
     (tree-sitter-hl-face:operator                 :foreground base08 :weight normal)
     (tree-sitter-hl-face:punctuation              :foreground base03 :weight normal)
     (tree-sitter-hl-face:punctuation.bracket      :foreground base03 :weight normal)
     (tree-sitter-hl-face:punctuation.delimiter    :foreground base03 :weight normal)
     (tree-sitter-hl-face:punctuation.special      :foreground base03 :weight normal)
     (tree-sitter-hl-face:keyword                  :foreground base08 :weight normal)
     (tree-sitter-hl-face:string                   :foreground base0A :weight normal)
     (tree-sitter-hl-face:constant                 :foreground base0E :weight normal)
     (tree-sitter-hl-face:constant.builtin         :foreground base0E :weight normal)
     (tree-sitter-hl-face:number                   :foreground base0E :weight normal)
     (tree-sitter-hl-face:comment                  :foreground base03 :weight normal)
     (tree-sitter-hl-face:function.macro           :foreground base09 :weight normal)
     (tree-sitter-hl-face:label                    :foreground base09 :weight normal)

;;;; neotree
     (neo-banner-face                              :foreground base0D)
     (neo-button-face                              :foreground base05)
     (neo-dir-link-face                            :foreground base0X)
     ;; (neo-dir-link-face                            :foreground base0A)
     (neo-expand-btn-face                          :foreground base0A)
     ;; (neo-expand-btn-face                          :foreground base03)
     (neo-file-link-face                           :foreground base06)
     (neo-header-face                              :foreground base0A)
     (neo-root-dir-face                            :foreground base08)
     (neo-vc-added-face                            :foreground base0B)
     (neo-vc-conflict-face                         :foreground base08)
     (neo-vc-default-face                          :foreground base05)
     (neo-vc-edited-face                           :foreground base0E)
     (neo-vc-ignored-face                          :foreground base03)
     (neo-vc-missing-face                          :foreground base08)
     (neo-vc-needs-merge-face                      :foreground base09)
     (neo-vc-needs-update-face                     :foreground base0A)
     (neo-vc-removed-face                          :foreground base08)
     (neo-vc-unlocked-changes-face                 :foreground base08)
     (neo-vc-up-to-date-face                       :foreground base05)
     (neo-vc-user-face                             :foreground base0E)
...
;; ============================================================================
;; Gruvbox Material Hard - Custom Palette
;; ============================================================================
;; Colors from doom-gruvbox-material-theme.el (hard variant)
;
(defvar gruvbox-mat-hard-theme-colors
  '(:base01 "#202020"    ;; bg (darker)
    :base00 "#242424"    ;; bg1
    :base02 "#32302f"    ;; bg4
    :base03 "#7c6f64"    ;; grey0 (comments)
    :base0X "#9c8b7c"    ;; grey0 (comments)
    :base04 "#a89984"    ;; grey1
    :base05 "#d4be98"    ;; fg
    :base06 "#ddc7a1"    ;; fg-alt
    :base07 "#ebdbb2"    ;; fg bright
    :base08 "#ea6962"    ;; red
    :base09 "#e78a4e"    ;; orange
    :base0A "#d8a657"    ;; yellow
    :base0B "#a9b665"    ;; green
    :base0C "#89b482"    ;; teal/aqua
    :base0D "#83a598"    ;; blue
    :base0E "#d3869b"    ;; magenta/purple
    :base0F "#bd6f3e")   ;; dark orange
  "Custom gruvbox material hard colors from doom-gruvbox-material.")

(deftheme gruvbox-mat-hard)
(base16-theme-define 'gruvbox-mat-hard gruvbox-mat-hard-theme-colors)
(provide-theme 'gruvbox-mat-hard)

(provide 'gruvbox-mat-hard-theme)

;;; gruvbox-mat-hard-theme.el ends here
