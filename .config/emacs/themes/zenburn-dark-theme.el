...
;;;; font-lock
     (font-lock-builtin-face                       :foreground base09)  ;; orange
     (font-lock-comment-delimiter-face             :foreground base03)
     (font-lock-comment-face                       :foreground base03)
     (font-lock-constant-face                      :foreground base09)  ;; orange (constants)
     ...
     (font-lock-keyword-face                       :foreground base0A)  ;; golden (keywords)
     (font-lock-negation-char-face                 :foreground base08)  ;; red (operators)
     (font-lock-preprocessor-face                  :foreground base09)  ;; orange (macros)
     (font-lock-regexp-grouping-backslash          :foreground base0A)
     (font-lock-regexp-grouping-construct          :foreground base09)
     (font-lock-string-face                        :foreground base08)  ;; red (strings)
     ...
     (font-lock-number-face                        :foreground base09)  ;; orange (numbers)
     (font-lock-operator-face                      :foreground base08)  ;; red (operators)
     (font-lock-punctuation-face                   :foreground base03)  ;; grey (punctuation)
     (font-lock-bracket-face                       :foreground base03)  ;; grey (brackets)
     (font-lock-delimiter-face                     :foreground base03)  ;; grey (delimiters)
...
;;;; tree-sitter / treesit
     ...
     (tree-sitter-hl-face:keyword                  :foreground base0A :weight normal)
     (tree-sitter-hl-face:string                   :foreground base08 :weight normal)
     (tree-sitter-hl-face:constant                 :foreground base09 :weight normal)
     (tree-sitter-hl-face:constant.builtin         :foreground base09 :weight normal)
     (tree-sitter-hl-face:number                   :foreground base09 :weight normal)
...
;; ============================================================================
;; Zenburn Dark - Custom Palette
;; ============================================================================
;; Colors from doom-zenburnv2-theme.el

(defvar zenburn-dark-theme-colors
  '(:base00 "#212121"    ;; bg
    :base01 "#2B2B2B"    ;; base1
    :base02 "#383838"    ;; bg-alt/base3
    :base03 "#7f7c77"    ;; grey (comments)
    :base0X "#99948b"    ;; grey (comments)
    :base04 "#afaca2ff"    ;; greyp
    :base05 "#d4d4c0"    ;; fg
    :base06 "#d4d4c0"    ;; fg-alt
    :base07 "#FFFFEF"    ;; fg+1 bright
    :base08 "#cb8b8b"    ;; red
    :base09 "#ca9d7d"    ;; orange
    :base0A "#d4b399"    ;; yellow
    :base0B "#a2bd90"    ;; green
    :base0C "#9bafb1"    ;; teal
    :base0D "#a6bcad"    ;; blue
    :base0E "#bd99b1ff"    ;; magenta
    :base0F "#93E0E3")   ;; cyan
  "Custom zenburn dark colors from doom-zenburnv2.")

(deftheme zenburn-dark)
(base16-theme-define 'zenburn-dark zenburn-dark-theme-colors)
(provide-theme 'zenburn-dark)

(provide 'zenburn-dark-theme)
