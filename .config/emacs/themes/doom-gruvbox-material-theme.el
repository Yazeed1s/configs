;;; themes/doom-gruvbox-material-theme.el -*- lexical-binding: t; -*-
...
(def-doom-theme doom-gruvbox-material
                ...
                ((bg          `(,gm/bg                "#161616"       nil            ))
                 ...
                 (builtin         magenta)
                 (comments       grey)
                 (doc-comments   (doom-darken (if doom-gruvbox-material-brighter-comments grey grey) 0.15))
                 (constants      magenta)
                 (functions      green)
                 (keywords       red)
                 (methods        green)
                 ...
                 (variables      fg)
                 (numbers        magenta)
                 (region         `(,(doom-lighten (car bg-alt) 0.15) ,@(doom-lighten (cdr bg) 0.35)))
                 (error          red)
                 (warning        yellow)
                 (success        green)
                 (vc-modified    orange)
                 ...
                 (modeline-bg-l
                  (if -modeline-bright
                    ...
                    `(,(doom-darken (car bg) 0.1) ,@(cdr bg))))
                 (modeline-bg-inactive   `(,(doom-darken (car bg) 0.1) ,@(cdr bg)))
                 (modeline-bg-inactive-l `(,(car bg) ,@(cdr bg))))
                ...
                ((elscreen-tab-other-screen-face :background "#353a42" :foreground "#1e2022")
                 ...
                 ((line-number &override) :foreground (doom-darken grey 0.25))
                 ((line-number-current-line &override) :foreground (doom-darken fg 0.25))
                 ...
                 ;; --- major-mode faces -------------------
                 ;; column indicator
                 (fill-column-indicator :foreground bg :background bg)
